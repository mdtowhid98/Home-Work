...
.ͼ4 .cm-line {caret-color: transparent !important;}
  ...
  <link rel="stylesheet" href="./group having subquery_files/Core.css" type="text/css">
<link rel="stylesheet" href="./group having subquery_files/Theme-Standard.css" type="text/css">

  <link rel="stylesheet" href="./group having subquery_files/font-apex.min.css" type="text/css">
<link rel="stylesheet" href="./group having subquery_files/Core(1).css" type="text/css">

  
  <link rel="stylesheet" href="./group having subquery_files/Vita.css" type="text/css">

  <link rel="stylesheet" href="./group having subquery_files/livesql.css" type="text/css">

  <link rel="stylesheet" href="./group having subquery_files/codeEditor.css" type="text/css">
<style type="text/css">
.t-Body-contentInner {
    flex-grow: 1;
    flex-basis: 0;
...
<header class="t-Header" id="t_Header" role="banner">
  ...
  <div class="t-Header-branding">
    ...
    <div class="t-Header-logo">
      <a href="https://livesql.oracle.com/apex/f?p=590:1000:17678147562085:::::" class="t-Header-logo-link"><img src="./group having subquery_files/oracle-logo.svg" alt="" class="apex-logo-img"><span class="apex-logo-text"><span class="u-vh">Oracle</span> Live SQL</span></a>
...
<div id="sql_panel" aria-label="SQL Editor" class="resize" style="position: absolute; width: 1581.31px; height: 300px; top: 0px;"><div id="editor" style="height: 100%;"><div class="cm-editor cm-focused ͼ1 ͼ2 ͼ4 cm-light"><div aria-live="polite" style="position: fixed; top: -10000px;"><div>Selection deleted</div></div><div tabindex="-1" class="cm-scroller"><div class="cm-gutters" aria-hidden="true" style="min-height: 438.833px; position: sticky;"><div class="cm-gutter cm-lineNumbers"><div class="cm-gutterElement" style="height: 0px; visibility: hidden; pointer-events: none;">99</div><div class="cm-gutterElement" style="height: 19.5833px; margin-top: 4px;">1</div><div class="cm-gutterElement" style="height: 19.5833px;">2</div><div class="cm-gutterElement" style="height: 19.5833px;">3</div><div class="cm-gutterElement" style="height: 19.5833px;">4</div><div class="cm-gutterElement" style="height: 19.5833px;">5</div><div class="cm-gutterElement" style="height: 19.5833px;">6</div><div class="cm-gutterElement" style="height: 19.5833px;">7</div><div class="cm-gutterElement" style="height: 19.5833px;">8</div><div class="cm-gutterElement" style="height: 19.5833px;">9</div><div class="cm-gutterElement" style="height: 19.5833px;">10</div><div class="cm-gutterElement" style="height: 19.5833px;">11</div><div class="cm-gutterElement cm-activeLineGutter" style="height: 19.5833px;">12</div><div class="cm-gutterElement" style="height: 19.5833px;">13</div><div class="cm-gutterElement" style="height: 19.5833px;">14</div><div class="cm-gutterElement" style="height: 19.5833px;">15</div><div class="cm-gutterElement" style="height: 19.5833px;">16</div><div class="cm-gutterElement" style="height: 19.5833px;">17</div><div class="cm-gutterElement" style="height: 19.5833px;">18</div><div class="cm-gutterElement" style="height: 19.5833px;">19</div><div class="cm-gutterElement" style="height: 19.5833px;">20</div><div class="cm-gutterElement" style="height: 19.5833px;">21</div><div class="cm-gutterElement" style="height: 19.5833px;">22</div></div><div class="cm-gutter cm-foldGutter"><div class="cm-gutterElement" style="height: 0px; visibility: hidden; pointer-events: none;"><span title="Unfold line">›</span></div><div class="cm-gutterElement" style="height: 19.5833px; margin-top: 4px;"><span title="Fold line">⌄</span></div><div class="cm-gutterElement" style="height: 19.5833px; margin-top: 117.5px;"><span title="Fold line">⌄</span></div><div class="cm-gutterElement cm-activeLineGutter" style="height: 19.5833px; margin-top: 58.75px;"></div></div></div><div spellcheck="false" autocorrect="off" autocapitalize="off" translate="no" contenteditable="true" class="cm-content" style="tab-size: 4;" role="textbox" aria-multiline="true" data-language="sql"><div class="cm-line"><span class="ͼb">select</span> last_name,job_id,salary</div><div class="cm-line">    <span class="ͼb">from</span> hr.employees</div><div class="cm-line">    <span class="ͼb">where</span> salary=(<span class="ͼb">select</span> min(salary)</div><div class="cm-line"><span class="ͼb">from</span> hr.employees);</div><div class="cm-line"><br></div><div class="cm-line"><br></div><div class="cm-line"><br></div><div class="cm-line"><span class="ͼb">select</span> department_id,min(salary)</div><div class="cm-line">    <span class="ͼb">from</span> hr.employees</div><div class="cm-line">    <span class="ͼb">group</span> <span class="ͼb">by</span> department_id</div><div class="cm-line">    <span class="ͼb">having</span>  min(salary)&gt;(<span class="ͼb">select</span> min(salary)</div><div class="cm-activeLine cm-line"><span class="ͼb">from</span> hr.employees</div><div class="cm-line">    <span class="ͼb">where</span> department_id=<span class="ͼd">110</span>)</div><div class="cm-line">    <span class="ͼb">order</span> <span class="ͼb">by</span> min(salary);</div><div class="cm-line"><br></div><div class="cm-line"><br></div><div class="cm-line"><br></div><div class="cm-line"><br></div><div class="cm-line"><br></div><div class="cm-line"><br></div><div class="cm-line">    </div><div class="cm-line"><br></div></div><div class="cm-layer cm-layer-above cm-cursorLayer" aria-hidden="true" style="z-index: 150; animation-duration: 1200ms; animation-name: cm-blink;"><div class="cm-cursor cm-cursor-primary" style="left: 171.375px; top: 219.417px; height: 17.3333px;"></div></div><div class="cm-layer cm-selectionLayer" aria-hidden="true" style="z-index: -2;"></div></div></div></div><input type="hidden" name="P1_SQL" id="P1_SQL" value="select last_name,job_id,salary
    from hr.employees
...
<span class="msg">
<h2 class="visuallyhidden">Result Set 21</h2><table summary="Results from query 21" class="u-Report">
<tbody><tr><th id="DEPARTMENT_ID_28079197689168586886087808520797815237">DEPARTMENT_ID</th><th id="MIN(SALARY)_28079197689168586886087808520797815237">MIN(SALARY)</th></tr><tr><td headers="DEPARTMENT_ID_28079197689168586886087808520797815237">70</td><td headers="MIN(SALARY)_28079197689168586886087808520797815237">10000</td></tr><tr><td headers="DEPARTMENT_ID_28079197689168586886087808520797815237">90</td><td headers="MIN(SALARY)_28079197689168586886087808520797815237">17000</td></tr>
</tbody></table><a href="https://livesql.oracle.com/apex/f?p=590:1:17678147562085:::::#" class="download-table2CSV">Download CSV</a><br>2 rows selected.</span></div></div>
</div>
</div>
<div id="R1076522878789928254" class=""><input type="hidden" name="P1_SAMPLE_ID" id="P1_SAMPLE_ID" value=""><input type="hidden" data-for="P1_SAMPLE_ID" value="_fPrxQ34fHsLe60Vw2ydJG01Y8tP3w7rvyJGM8uKigfTRejfV0Mb3woZYd6zgK-5IS4tXsro_f1zNg0z1Wj7Bg"><input type="hidden" name="P1_MIN_RESULT_SEQ" id="P1_MIN_RESULT_SEQ" value=""><input type="hidden" data-for="P1_MIN_RESULT_SEQ" value="meoHpHXS0ZmKHtQK_bJcVGtj04D1BZxZ8bv0ngNberch7yvcVoVSnXgRPK0zO--cTCactdP6icpb682KAuSGFQ"><input type="hidden" name="P1_SHOW_LEARN_SIDEBAR" id="P1_SHOW_LEARN_SIDEBAR" value="N"><input type="hidden" data-for="P1_SHOW_LEARN_SIDEBAR" value="vy4TMc1bwx_KBHrSr5jcZqS34XAGlf_mbbrTgzY3190wQMZdd1BNSCAI3eOE1m6lKA6snefitTVZzkWgB-lq6A"><input type="hidden" name="P1_LEARN_CONTEXT" id="P1_LEARN_CONTEXT" value=""><input type="hidden" data-for="P1_LEARN_CONTEXT" value="mB3dyC6uNkLB9SeojqK-yxU-lgRx9BQ2PvxsGcXyrO4sCgt6RiYwjgnpYAykS6NSjt4W8v7Is5an2uqCoUbj7w"><input type="hidden" name="P1_SQL2" id="P1_SQL2" value="
select department_id,min(salary)
    from hr.employees
    group by department_id
    having  min(salary)&gt;(select min(salary)
...
<script src="./group having subquery_files/jquery-3.6.0.js.download"></script>
<script src="./group having subquery_files/core.js.download"></script>
<script src="./group having subquery_files/debug.js.download"></script>
<script src="./group having subquery_files/util.js.download"></script>
<script src="./group having subquery_files/locale.js.download"></script>
<script src="./group having subquery_files/lang.js.download"></script>
<script src="./group having subquery_files/message.js.download"></script>
<script src="./group having subquery_files/wwv_flow.js_messages"></script>
<script src="./group having subquery_files/date.js.download"></script>
<script src="./group having subquery_files/storage.js.download"></script>
<script src="./group having subquery_files/event.js.download"></script>
<script src="./group having subquery_files/region.js.download"></script>
<script src="./group having subquery_files/item.js.download"></script>
<script src="./group having subquery_files/apex_5_0.js.download"></script>
<script src="./group having subquery_files/navigation.js.download"></script>
<script src="./group having subquery_files/server.js.download"></script>
<script src="./group having subquery_files/page.js.download"></script>
<script src="./group having subquery_files/widget.js.download"></script>
<script src="./group having subquery_files/widget.util.js.download"></script>
<script src="./group having subquery_files/clipboard.js.download"></script>
<script src="./group having subquery_files/dynamic_actions_core.js.download"></script>
<script src="./group having subquery_files/dynamic_actions.js.download"></script>
<script src="./group having subquery_files/session.js.download"></script>
<script src="./group having subquery_files/jquery-ui-apex.js.download"></script>
<script src="./group having subquery_files/actions.js.download"></script>
<script src="./group having subquery_files/hammer-2.0.8.js.download"></script>
<script src="./group having subquery_files/widget.checkbox.js.download"></script>
<script src="./group having subquery_files/widget.checkboxAndRadio.js.download"></script>
<script src="./group having subquery_files/widget.jetDatePicker.js.download"></script>
<script src="./group having subquery_files/widget.popupLov.js.download"></script>
<script src="./group having subquery_files/widget.selectList.js.download"></script>
<script src="./group having subquery_files/widget.textField.js.download"></script>
<script src="./group having subquery_files/widget.textarea.js.download"></script>
<script src="./group having subquery_files/widget.yesNo.js.download"></script>
<script src="./group having subquery_files/widget.menu.js.download"></script>
<script src="./group having subquery_files/widget.popup.js.download"></script>
<script src="./group having subquery_files/widget.toggleCore.js.download"></script>
<script src="./group having subquery_files/widget.collapsible.js.download"></script>
<script src="./group having subquery_files/tooltipManager.js.download"></script>
<script src="./group having subquery_files/theme.js.download"></script>
<script src="./group having subquery_files/pwa.js.download"></script>
...
<script src="./group having subquery_files/widget.stickyWidget.js.download"></script>
<script src="./group having subquery_files/theme42.js.download"></script>


<script src="./group having subquery_files/script.js.download"></script>
<script src="./group having subquery_files/table2CSV.js.download"></script>
<script src="./group having subquery_files/widget.apexTabs.js.download"></script>

<script src="./group having subquery_files/widget.splitter.js.download"></script>
<script src="./group having subquery_files/xmlRenderer.js.download"></script>
<script src="./group having subquery_files/xmlPrettyPrint.js.download"></script>
<script src="./group having subquery_files/jsonPrettyPrint.js.download"></script>
<script src="./group having subquery_files/editor.bundle.js.download"></script>
<script type="text/javascript">
...
<script src="./group having subquery_files/widget.treeView.js.download"></script>
...
<script src="./group having subquery_files/require.js.download"></script>
<script src="./group having subquery_files/requirejs.jetConfig.js.download"></script>
<script src="./group having subquery_files/codeEditor.js.download"></script>
<script type="text/javascript">
